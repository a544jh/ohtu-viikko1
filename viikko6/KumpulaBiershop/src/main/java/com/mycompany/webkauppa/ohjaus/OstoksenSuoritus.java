...
public class OstoksenSuoritus implements Komento{
    ...
    private Toimitusjarjestelma toimitusjarjestelma;
    ...
    protected OstoksenSuoritus(Varasto varasto, Pankki pankki, Toimitusjarjestelma toimitusjarjestelma, String nimi, String osoite, String luottokorttinumero, Ostoskori kori) {
